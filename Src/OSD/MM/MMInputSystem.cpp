...
DIKeyMapStruct CMMInputSystem::s_keyMap[] = 
{
	// General keys
	{ "BACKSPACE",			DIK_BACK },
	{ "TAB",				DIK_TAB },
...
const char *CMMInputSystem::ConstructName(bool useRawInput, bool useXInput)
{
	if (useRawInput)
...
CMMInputSystem::CMMInputSystem(const Util::Config::Node &config, SDL_Window *window, bool useRawInput, bool useXInput) : 
...
bool CMMInputSystem::GetRegString(HKEY regKey, const char *regPath, std::string &str)
{
...
bool CMMInputSystem::GetRegDeviceName(const char *rawDevName, char *name)
{
...
void CMMInputSystem::OpenKeyboardsAndMice()
{
	if (m_useRawInput)
	{
...
void CMMInputSystem::ActivateKeyboardsAndMice()
{
...
void CMMInputSystem::PollKeyboardsAndMice()
{
	if (m_useRawInput)
	{
...
void CMMInputSystem::CloseKeyboardsAndMice()
{
	if (m_useRawInput)
	{
		if (m_activated)
...
void CMMInputSystem::ProcessRawInput(HRAWINPUT hInput)
{
	// RawInput data event
	BYTE buffer[4096];
	LPBYTE pBuf = buffer;
...
void CMMInputSystem::OpenJoysticks()
{
...
void CMMInputSystem::ActivateJoysticks()
{
...
void CMMInputSystem::PollJoysticks()
{
...
void CMMInputSystem::CloseJoysticks()
{
...
HRESULT CMMInputSystem::CreateJoystickEffect(LPDIRECTINPUTDEVICE8 joystick, int axisNum, ForceFeedbackCmd ffCmd, LPDIRECTINPUTEFFECT *pEffect)
{
...
void CMMInputSystem::LoadXInputDLL()
{
...
bool CMMInputSystem::InitializeSystem()
{
	if (m_useRawInput)
	{
...
int CMMInputSystem::GetKeyIndex(const char *keyName)
{
...
const char *CMMInputSystem::GetKeyName(int keyIndex)
{
...
bool CMMInputSystem::IsKeyPressed(int kbdNum, int keyIndex)
{
...
int CMMInputSystem::GetMouseAxisValue(int mseNum, int axisNum)
{
	if (m_useRawInput)
	{
...
int CMMInputSystem::GetMouseWheelDir(int mseNum)
{
	if (m_useRawInput)
	{
...
bool CMMInputSystem::IsMouseButPressed(int mseNum, int butNum)
{
	if (m_useRawInput)
	{
...
int CMMInputSystem::GetJoyAxisValue(int joyNum, int axisNum)
{
...
bool CMMInputSystem::IsJoyPOVInDir(int joyNum, int povNum, int povDir)
{
...
bool CMMInputSystem::IsJoyButPressed(int joyNum, int butNum)
{
...
bool CMMInputSystem::ProcessForceFeedbackCmd(int joyNum, int axisNum, ForceFeedbackCmd ffCmd)
{
...
bool CMMInputSystem::ConfigMouseCentered()
{
...
CInputSource *CMMInputSystem::CreateAnyMouseSource(EMousePart msePart)
{
...
int CMMInputSystem::GetNumKeyboards()
{
...
int CMMInputSystem::GetNumJoysticks()
{
	// Return number of joysticks found
	return m_diJoyInfos.size();
}

const KeyDetails *CMMInputSystem::GetKeyDetails(int kbdNum)
{
...
void CMMInputSystem::SetMouseVisibility(bool visible)
{
	if (m_useRawInput)
...
void CMMInputSystem::UngrabMouse()
{
